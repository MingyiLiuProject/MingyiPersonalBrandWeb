  ...
  return (
    <main>
      ...
      <section className="page-shell max-w-4xl pb-14 pt-12 sm:pb-20 sm:pt-16">
        <p className="micro-label mb-6 text-[var(--accent)]">02 / About</p>
      ...
      <section className="page-shell max-w-4xl">
        <div className="section-rule mb-5">
          <p className="micro-label text-[var(--muted)]">A path through research and product</p>
        </div>
        ...
        <div className="mt-16 grid gap-7 border-t border-[var(--line)] pt-8 text-lg leading-8 text-[var(--muted)] sm:grid-cols-[1fr_auto] sm:items-end">
          <p>Outside work, I&apos;m usually reading, trying a small tool idea, or learning something I&apos;ll probably turn into a note later.</p>
          <Link href="/contact" className="soft-link whitespace-nowrap font-medium text-[var(--foreground)]">Let&apos;s talk ↗</Link>
        </div>
      </section>
      <SiteFooter />
    </main>
